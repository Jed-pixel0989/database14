/**
 * SEAIT ENROLL - Offline Lucide Icon Engine
 * Provides 100% offline SVG icon rendering when internet is unavailable.
 */
(function(window) {
    const iconSvgs = {
        ...
        'book-plus': '<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/><path d="M6 6h10"/><path d="M6 10h10"/><path d="M11 14v6"/><path d="M8 17h6"/>',
        ...
        'calendar-plus': '<rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><line x1="10" x2="14" y1="15" y2="15"/><line x1="12" x2="12" y1="13" y2="17"/>',
        ...
        'file-signature': '<path d="M20 19.5v.5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8.5L19 6.5V10"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M18.42 15.61a2.1 2.1 0 1 1 2.97 2.97L15 25l-4 1 1-4Z"/>',
    ...
    function renderIcons(container) {
        ...
        elements.forEach(el => {
            ...
            const pathData = iconSvgs[iconName];
            if (!pathData) return;
            ...
            // Replace tag or content
            el.innerHTML = '';
            el.appendChild(svg);
        });
    }

    // Export global lucide object if not already present or as offline fallback
    if (!window.lucide || !window.lucide.createIcons) {
        ...
        // Wrap createIcons to ensure fallback is always available
        ...
        window.lucide.createIcons = function() {
            ...
            // Double check un-rendered icons safely without CSS :has() selector
            const allLucide = document.querySelectorAll('i[data-lucide]');
            let needsRender = false;
            allLucide.forEach(el => {
